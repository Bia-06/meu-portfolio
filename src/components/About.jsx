...
export default function About() {
  const { t, language } = useSettings(); // Adicionei language aqui
  ...
  // Partículas flutuantes para o About
      ...
      <div className="container mx-auto px-6 max-w-6xl relative z-10">
        <div className={`transition-all duration-1000 ${
          ...
          <div className="flex flex-col md:flex-row items-center gap-12">
            {/* Foto à esquerda - COM SUA FOTO REAL */}
              ...
              <div className="relative group">
                <div className="w-72 h-72 md:w-80 md:h-80 lg:w-96 lg:h-96 rounded-2xl shadow-2xl overflow-hidden border-4 border-white dark:border-gray-800 bg-gradient-to-br from-purple-400 to-pink-500 p-1">
                  <div className="w-full h-full rounded-xl overflow-hidden">
                    <img 
                      src="/beatriz-foto.jpg" // ALTERE PARA O CAMINHO DA SUA FOTO
                      alt="Beatriz Pires"
